...
- `/gantry:adjust "<发生了什么>"` — 对当前活跃 change 打开或追加 `.specs/<change-id>/PATCH.md`

## 规则

- ship 前一个 change 最多只有一个 open patch。
...
2. CLI 行为：
   - 创建或追加 `.specs/<change-id>/PATCH.md`
...
5. `/gantry:ship` 会阻止未闭环的 open patch
